...
teaser:
  text: |2-
    ...
    Este documento describe las funciones CSS que se admiten actualmente en AMP
...
Este documento describe las funciones CSS que se admiten actualmente en los correos electrónicos de AMP.

## Aplicar CSS<a name="applying-css"></a>

### Hoja de estilo interna<a name="internal-stylesheet"></a>

Cuando se usa una hoja de estilo interna, el CSS se especifica dentro de una única etiqueta `<style amp-custom>` ubicada en la etiqueta `<head>` del correo electrónico.

### Estilos en línea<a name="inline-styles"></a>

Además de una hoja de estilo interna, se pueden especificar estilos en línea en cualquier elemento utilizando el [atributo de `style`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-style) .

### Hoja de estilo externa<a name="external-stylesheet"></a>

Las hojas de estilo externas **no** son compatibles con AMP para correo electrónico.

El uso de `<link rel="stylesheet" href="...">` no está permitido en ningún lugar del correo electrónico.

## Selectores de CSS compatibles<a name="supported-css-selectors"></a>

### Selectores simples<a name="simple-selectors"></a>

- [Tipo de selector de](https://developer.mozilla.org/en-US/docs/Web/CSS/Type_selectors) `elementname`
- [Selector de clases](https://developer.mozilla.org/en-US/docs/Web/CSS/Class_selectors) `.classname`
- [Selector de ID](https://developer.mozilla.org/en-US/docs/Web/CSS/ID_selectors) `#idname`
...
- [Combinador general de hermanos](https://developer.mozilla.org/en-US/docs/Web/CSS/General_sibling_combinator) `A ~ B`
- [Combinador infantil](https://developer.mozilla.org/en-US/docs/Web/CSS/Child_combinator) `A > B`
- [Combinador descendiente](https://developer.mozilla.org/en-US/docs/Web/CSS/Descendant_combinator) `AB`
...
## Propiedades CSS compatibles<a name="supported-css-properties"></a>
...
Las siguientes propiedades de CSS tienen restricciones adicionales:

Propiedad | Restricciones
--- | ---
[`cursor`](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor) | Los únicos valores permitidos son `pointer` e `initial` .
[`filter`](https://developer.mozilla.org/en-US/docs/Web/CSS/filter) | `url()` no está permitido.
[`transition`](https://developer.mozilla.org/en-US/docs/Web/CSS/transition) | Solo se pueden `opacity` , la `transform` , la `visibility` y `offset-distance` .
[`visibility`](https://developer.mozilla.org/en-US/docs/Web/CSS/visibility) | Los únicos valores permitidos son `hidden` , `visible` e `initial` .
[`z-index`](https://developer.mozilla.org/en-US/docs/Web/CSS/z-index) | Solo se permiten valores entre -100 y 100.

## En reglas<a name="at-rules"></a>

La única [regla at](https://developer.mozilla.org/en-US/docs/Web/CSS/At-rule) actualmente admitida es `@media` . Consulte [Funciones multimedia](#media-features) para obtener más información.

### Fuentes personalizadas ( `@font-face` )<a name="custom-fonts-font-face"></a>

Las fuentes personalizadas **no** son compatibles con AMP para correo electrónico.

## Funciones multimedia<a name="media-features"></a>
